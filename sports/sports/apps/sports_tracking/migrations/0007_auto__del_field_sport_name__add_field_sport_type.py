...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sport.name'
        db.delete_column('sports_tracking_sport', 'name')

        # Adding field 'Sport.type'
        db.add_column('sports_tracking_sport', 'type',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length='300'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sport.name'
        db.add_column('sports_tracking_sport', 'name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length='200'),
                      keep_default=False)

        # Deleting field 'Sport.type'
        db.delete_column('sports_tracking_sport', 'type')
