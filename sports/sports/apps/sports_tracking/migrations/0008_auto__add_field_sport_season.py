...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sport.season'
        db.add_column('sports_tracking_sport', 'season',
                      self.gf('django.db.models.fields.CharField')(default='FL', max_length='300'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sport.season'
        db.delete_column('sports_tracking_sport', 'season')
