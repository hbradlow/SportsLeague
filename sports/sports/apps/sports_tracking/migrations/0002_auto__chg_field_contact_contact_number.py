...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.contact_number'
        db.alter_column('sports_tracking_contact', 'contact_number', self.gf('django.db.models.fields.CharField')(default=0, max_length='200'))

    def backwards(self, orm):

        # Changing field 'Contact.contact_number'
        db.alter_column('sports_tracking_contact', 'contact_number', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'sports_tracking.game': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'games_won'", 'null': 'True', 'to': "orm['sports_tracking.Team']"})
        },
