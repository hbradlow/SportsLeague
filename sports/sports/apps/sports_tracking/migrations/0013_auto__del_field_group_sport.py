...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'sports_tracking.group': {
            'Meta': {'object_name': 'Group'},
            'fraternity': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sports_tracking.Fraternity']", 'symmetrical': 'False'}),
        ...
        'sports_tracking.sport': {
            ...
            'group': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sports_tracking.Group']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
