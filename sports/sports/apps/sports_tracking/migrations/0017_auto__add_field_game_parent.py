...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.parent'
        db.add_column('sports_tracking_game', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sports_tracking.Game'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.parent'
        db.delete_column('sports_tracking_game', 'parent_id')
