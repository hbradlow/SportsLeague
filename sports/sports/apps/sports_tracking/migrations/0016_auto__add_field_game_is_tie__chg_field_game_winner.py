...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.is_tie'
        db.add_column('sports_tracking_game', 'is_tie',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Game.winner'
        db.alter_column('sports_tracking_game', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sports_tracking.Team']))

    def backwards(self, orm):
        # Deleting field 'Game.is_tie'
        db.delete_column('sports_tracking_game', 'is_tie')


        # Changing field 'Game.winner'
        db.alter_column('sports_tracking_game', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sports_tracking.Team']))
