...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sport.slug'
        db.add_column('sports_tracking_sport', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, default='', unique=True, populate_from='type', overwrite=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sport.slug'
        db.delete_column('sports_tracking_sport', 'slug')
