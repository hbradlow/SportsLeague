...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Player.fraternity'
        db.delete_column('sports_tracking_player', 'fraternity_id')

        # Adding field 'Game.sport'
        db.add_column('sports_tracking_game', 'sport',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sports_tracking.Sport']),
                      keep_default=False)

        # Removing M2M table for field group on 'Sport'
        db.delete_table('sports_tracking_sport_group')
        ...
        # Removing M2M table for field fraternity on 'Group'
        db.delete_table('sports_tracking_group_fraternity')
    ...
    def backwards(self, orm):
        # Adding field 'Player.fraternity'
        db.add_column('sports_tracking_player', 'fraternity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sports_tracking.Fraternity']),
                      keep_default=False)

        # Deleting field 'Game.sport'
        db.delete_column('sports_tracking_game', 'sport_id')

        # Adding M2M table for field group on 'Sport'
        db.create_table('sports_tracking_sport_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sport', models.ForeignKey(orm['sports_tracking.sport'], null=False)),
            ('group', models.ForeignKey(orm['sports_tracking.group'], null=False))
        ))
        db.create_unique('sports_tracking_sport_group', ['sport_id', 'group_id'])

        # Deleting field 'Group.sport'
        db.delete_column('sports_tracking_group', 'sport_id')

        # Adding M2M table for field fraternity on 'Group'
        db.create_table('sports_tracking_group_fraternity', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['sports_tracking.group'], null=False)),
            ('fraternity', models.ForeignKey(orm['sports_tracking.fraternity'], null=False))
        ))
        db.create_unique('sports_tracking_group_fraternity', ['group_id', 'fraternity_id'])
